...
export const variableDefinitions: Record<string, VariableDefinition> = {
    ...
    constraint1Intercept: {
        defaultValue: 6,
        type: 'number',
        label: 'Labor Constraint Y-Intercept',
        description: 'Y-intercept of the labor constraint line (2x + 3y ≤ 18)',
        min: 2,
        max: 10,
        step: 0.5,
        color: '#F7B23B',
    ...
    constraint2Intercept: {
        defaultValue: 10,
        type: 'number',
        label: 'Material Constraint Y-Intercept',
        description: 'Y-intercept of the material constraint line (4x + 2y ≤ 20)',
        min: 2,
        max: 12,
        step: 0.5,
        color: '#AC8BF9',
